 ...
 *
 * Identical to the one the 2D blank recipe ships, down to the signal names: the HUD is
 * 2D in both, because a 3D game's score is still read on a flat overlay.
 */
