    ...
    return {
      ...
      properties: [
        ...
        },
        {
          ...
          setValue: (n, v) => {
            (n as Button2D).buttonAction = String(v);
          },
        },
        {
          name: 'textureNormal',
          ...
          setValue: (n, v) => {
            (n as Button2D).setStateTextureRef('normal', v);
          },
        },
        {
          name: 'textureHover',
          ...
          setValue: (n, v) => {
            (n as Button2D).setStateTextureRef('hover', v);
          },
        },
        {
          name: 'texturePressed',
          ...
          setValue: (n, v) => {
            (n as Button2D).setStateTextureRef('pressed', v);
          },
        },
        {
        ...
        },
        {
          ...
          type: 'string',
          ui: {
            label: 'Normal Sprite Key',
            group: 'Skin',
            editor: 'localization-key',
            description:
              'Localization sprite key for the normal state (wins over the authored sprite when resolvable)',
          },
          getValue: n => (n as Button2D).stateTextureKeys.normal ?? '',
          setValue: (n, v) => {
            (n as Button2D).setStateTextureKey('normal', v);
          },
        },
        {
          ...
          type: 'string',
          ui: {
            label: 'Hover Sprite Key',
            group: 'Skin',
            editor: 'localization-key',
            description: 'Localization sprite key for the hover state',
          },
          getValue: n => (n as Button2D).stateTextureKeys.hover ?? '',
          setValue: (n, v) => {
            (n as Button2D).setStateTextureKey('hover', v);
          },
        },
        {
          ...
          type: 'string',
          ui: {
            label: 'Pressed Sprite Key',
            group: 'Skin',
            editor: 'localization-key',
            description: 'Localization sprite key for the pressed state',
          },
          getValue: n => (n as Button2D).stateTextureKeys.pressed ?? '',
          setValue: (n, v) => {
            (n as Button2D).setStateTextureKey('pressed', v);
          },
        },
        {
          ...
          type: 'string',
          ui: {
            label: 'Disabled Sprite Key',
            group: 'Skin',
            editor: 'localization-key',
            description: 'Localization sprite key for the disabled state',
          },
          getValue: n => (n as Button2D).stateTextureKeys.disabled ?? '',
          setValue: (n, v) => {
            (n as Button2D).setStateTextureKey('disabled', v);
          },
        },
      ],
      groups: {
