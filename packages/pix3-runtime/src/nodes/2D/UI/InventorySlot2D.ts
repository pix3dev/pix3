import { Mesh, MeshBasicMaterial, PlaneGeometry, CanvasTexture, Vector2 } from 'three';
    ...
    return {
      ...
      properties: [
        ...
        },
        {
          ...
          setValue: (n, v) => {
            (n as InventorySlot2D).setQuantity(Number(v));
          },
        },
        {
          name: 'showQuantity',
        ...
        },
        {
          ...
          setValue: (n, v) => {
            (n as InventorySlot2D).selectionColor = String(v);
          },
        },
        {
          name: 'selectedAction',
          ...
          setValue: (n, v) => {
            (n as InventorySlot2D).selectedAction = String(v);
          },
        },
      ],
      groups: {
